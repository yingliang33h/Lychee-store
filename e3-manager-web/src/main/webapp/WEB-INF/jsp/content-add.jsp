	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <a href="javascript:void(0)" class="easyui-linkbutton onePicUpload">Upload Image</a>
	            </td>
	        </tr>
	        <tr>
	            <td>Image2:</td>
	...
	var contentAddPage  = {
			submitForm : function (){
				if(!$('#contentAddForm').form('validate')){
					$.messager.alert('Error','The form is not conpleted!');
					return ;
				}
				...
				$.post("/content/save",$("#contentAddForm").serialize(), function(data){
					if(data.status == 200){
						$.messager.alert('Info','Successfully added content!');
