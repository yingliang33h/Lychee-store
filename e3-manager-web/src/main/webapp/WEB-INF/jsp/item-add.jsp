...
<div style="padding:10px 10px 10px 10px">
	...
	<div style="padding:5px">
	    ...
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="clearForm()">Discard</a>
	</div>
</div>
	...
	function submitForm(){
		...
		*/
		...
		$.post("/item/save",$("#itemAddForm").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('Info','Successfully added this item.');
				$("#tabs").tabs("close", "Add items");
