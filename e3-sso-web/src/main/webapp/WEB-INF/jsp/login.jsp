...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.lycheestore.net"><img src="/images/logo.png" border="0"><span style="float:right"><strong>Welcome to Lychee Store!</strong> </span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="javascript:void(0)" target="_blank"><img src="/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		<!-- login -->
		<div class="login">
				...
				<div class="logincon">
					...
					<form id="formlogin" method="post" >
						...
						<li class="m-t5" id="btn_sub">
							...
							<a href="javascript:void(0)" id="login_sub" class="login_btn" style="margin:40px">Login</a>
						</li>
					<div>
</div></form>
					</ul>
	...
	<div class="footer">
		<p>
			This website is created by Sylvia Liang<br>
		</p>
	</div>
	<!-- /footer -->
