...
OkArr[0]= 'Validation Succeed！';
memArr[0]	= 'Please enter your email address!';
memArr[1]	= 'Invalid phone number';
memArr[2]	= 'Invalid email address';
pwdArr[0]	= 'Please enter a valid password!Password must contain at least 6 charactors';
pwdArr[1]	='Password must contain at least 6 charactors';
pwdArr[2]	='密码太简单，建议使用数字、字母、下划线组合';
pwdArr[3]	='Password must contain at least 6 charactors';
pwd2Arr[0]	= '请再次输入密码';
pwd2Arr[1]	='Password dose not match!';
mcodeArr[0]='请输入短信验证码';
mcodeArr[1]='短信验证码不正确';
codeArr[0]	= '请输入验证码';
codeArr[1]	='网站验证码不正确';
